export const TOS_TITLE = "Terms of Service";

export const TOS_INTRO = "Please review our terms of service";

export const TOS_HIGHLIGHTS_HEADING = "Some highlights:";

export const TOS_HIGHLIGHT_BULLETS = [
...
export const TOS_PRIVACY_LINK_LABEL = "Privacy Policy";

export const TOS_PRIVACY_URL = "https://am.brilliantgrades.com/privacy";

export const TOS_COPPA_BODY =
  "It states that you're on board with us using your child's information safely and transparently, as outlined in our Privacy Policy and in accordance with COPPA. We're dedicated to ensuring a secure and enjoyable educational experience for your child.";

export const TOS_READ_FULL_LABEL = "Read full terms of service";

export const TOS_SIGN_INSTRUCTION = "Please sign to continue";

export const TOS_PARENT_NAME_LABEL = "Parent Name";

export const TOS_SIGN_BUTTON_LABEL = "Sign";

export const TOS_VIEW_SIGNED_LABEL = "View Signed ToS";
